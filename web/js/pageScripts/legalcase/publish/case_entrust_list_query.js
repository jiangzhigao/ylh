jQuery(function(){
    ...
    function _optionsHtml(){
        ...
        _operHtml.push('<ul class="dropdown-menu" role="menu">');
        _operHtml.push('<li><a href="/view/legalcase/publish/caseEntrustDetail.jsp?orderCode=D0001">查看详情</a></li>');
        _operHtml.push('<li><a href="#">审核通过</a></li>');
        _operHtml.push('<li><a href="#">不通过</a></li>');
        _operHtml.push('<li><a href="#">结案</a></li>');
