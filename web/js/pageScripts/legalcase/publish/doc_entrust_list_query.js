jQuery(function(){
    ...
    function _bind () {
        ...
        $('body').on('click', ".opt li a", function() {
            ...
            if($this.parent().index()==0){//查看详情
                ...
                if(s == '0'){
                    bizUrl = "/view/legalcase/publish/tempDocEntrustDetail_.jsp";
                }else{
                    bizUrl = "/view/legalcase/publish/docEntrustDetail_.jsp";
                }
    ...
    function _optionsHtml(id,clz){
        ...
        _operHtml.push('<li style="border-bottom: 1px dashed #CCC;"><a bz-url="/view/legalcase/publish/docEntrustDetail.jsp" bid="'+id+'" target="ylxmain">查看详情</a></li>');
