jQuery(function(){
    ...
    function _optionsHtml(id,clz){
        ...
        _operHtml.push('<a class="dropdown-toggle" data-toggle="dropdown" style="color: #337AB7;" aria-expanded="true">管理<span class="caret"></span></a>');
                ...
                if (result.success) {
                    ...
                    if (result.withdrawals != null && result.withdrawals.length > 0) {
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            _html.push('<td>' + auditStatusArray[auditStatusInt] + '</td>');
                            clz = auditStatusInt == 0?"":"no-editable";
