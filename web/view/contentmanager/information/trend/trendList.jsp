        ...
        <div class="col-xs-12">
            <section class="box ">
                <header class="panel_header">
                    <h4 class="title pull-left">动态管理</h4>
                    <div class="actions panel_actions pull-right" style="line-height: 23px;">
                        <a href="addTrend.jsp" class="btn btn-info" style="padding: 3px 6px;margin-top:9px;">
...
<script type="text/javascript" src="/js/pageScripts/content/information/trend/query_trend.js"></script>
<!-- START FOOTER -->
