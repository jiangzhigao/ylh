        ...
        <div class="col-xs-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">留言详情</h2>
                                ...
                                <div class="" style="background-color: #f3f3f4;height: 500px;width: 95%;margin-left: 30px;">
                                    <div class="uprofile-content" style="background-color: #f3f3f4;height: 500px;min-height: 500px;position:relative;">
                                        ...
                                        <div class="uprofile_wall_posts col-md-12 col-sm-12 col-xs-12">
                                            <div class="info-wrapper col-md-12 col-sm-12 col-xs-12" style="height: 380px;overflow:auto;overflow-x:hidden;">
                                        ...
                                        <div class="enter_post col-md-12 col-sm-12 col-xs-12" style="position:absolute;left:0;bottom:0;">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <textarea class="form-control autogrow" id="field-7" placeholder="请回复客户留言" style="overflow: hidden; word-wrap: break-word; height: 70px;margin-left: 14px;"></textarea>
                                                </div>
                                            </div>
                                            <div class="enter_post_btns col-md-12 col-sm-12 col-xs-12">
                                                <a href="#" class="btn btn-md pull-right btn-info">发送</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
