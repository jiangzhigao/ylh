...
<section class="wrapper" style='margin-top:0px;display:inline-block;width:100%;padding:15px 0 0 0;'>
    <header class="panel_header" style="background-color: #fff;margin-top:45px;">
        <h4 class="title pull-left" style="font-size: 15px;">律师列表 / 专业领域添加</h4>
    </header>

    <div class="col-xs-12">
        <section class="box ">
            <header class="panel_header">
                <h2 class="title pull-left title-bold">专业领域添加</h2>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label class="col-xs-2 control-label" for="name">专业领域添加</label>
                                    <div class="col-xs-5">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-5">
                                        <input type="text" class="form-control" placeholder="" value="" id="sortNo" name="sortNo"
                                               maxlength="16">
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript" src="/js/pageScripts/custom/lawyer/speciality/add_speciality.js"></script>
<!-- START FOOTER -->
<!--  FOOTER - END -->
</body>
