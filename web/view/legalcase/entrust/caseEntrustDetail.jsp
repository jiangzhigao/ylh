        ...
        <section class="box ">
            ...
            <div class="content-body">
                <div class="dataTables_wrapper no-footer">
                    <form class="form-horizontal" id="form_dtl" action="#" method="post" novalidate="novalidate">
                        ...
                        <div class="row" id="lawyerList" style="display: none;">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-1">
                                        <label class="control-label" id="lawyerNum" style="font-weight: 500;"></label>
                                    </div>
                                    <div class="col-xs-1">
                                        <div class="controls">
...
<script type="text/javascript" src="/js/pageScripts/legalcase/entrust/case_entrust_detail.js"></script>
