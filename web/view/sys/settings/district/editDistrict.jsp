        ...
        <div class="col-xs-12">
            <section class="box ">
                <header class="panel_header">
                    <h2 class="title pull-left">编辑</h2>
                    ...
                    <div class="dataTables_wrapper no-footer">
                        <form class="form-horizontal" id="form_edit" action="#" method="post" novalidate="novalidate">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label class="col-xs-2 control-label" for="cityId">城市ID</label>
                                        <div class="col-xs-4">
                                            <label class="control-label" id="cityId" name="cityId">110001</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label class="col-xs-2 control-label" for="provinceName">省份名</label>
                                        <div class="col-xs-4">
                                            <label class="control-label" id="provinceName" name="provinceName"></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label class="col-xs-2 control-label" for="name">城市名称</label>
                                        <div class="col-xs-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-4">
                                            <select class="form-control" id="status" style="border-color: #e1e1e1;">
                                                ...
                                                <option value="0" id="status_2" name="status">停用</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src="/js/pageScripts/sys/basic/district/edit_district.js"></script>
<!--  FOOTER - END -->
</body>
