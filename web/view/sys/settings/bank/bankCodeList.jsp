        ...
        <div class="col-xs-12">
            <section class="box ">
                <header class="panel_header">
                    <h4 class="title pull-left">银行编码列表</h4>
                    <div class="actions panel_actions pull-right" style="line-height: 23px;">
                        <a href="addBankCode.jsp" class="btn btn-info" style="padding: 3px 6px;margin-top:9px;">
                        ...
                        <form class="form-horizontal" id="form_query" action="#" method="post" novalidate="novalidate">
                            <div class="row">
                                <div class="col-xs-2 move20">
                                    <input type="text" id="bankName" class="form-control" placeholder="银行名称">
                                </div>
